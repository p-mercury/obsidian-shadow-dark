...
import { marshalPc, unmarshalPc, type Pc } from "../../types/pc";

class PcBlockChild extends MarkdownRenderChild {
	...
	onload() {
		...
		try {
			character = unmarshalPc(this.source);
		} catch {
...
export function renderPcBlock(
	app: App,
	source: string,
	el: HTMLElement,
	ctx: MarkdownPostProcessorContext,
) {
	ctx.addChild(new PcBlockChild(el, app, source, ctx));
}
